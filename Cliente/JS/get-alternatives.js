function alternativas() {
    ...
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": "http://" + local + ":" + port + "/api/get-alternatives",
        "method": "POST",
        "headers": {
        ...
        success: function (response) {
             ...
             *
             * LA DIFERENCIA EN LA LOGICA DE GET-ALTERNATIVAS Y GET-ROUTE ES QUE GET-ALTERNATIVES
             * NECESITA UN CICLO EXTRA, PARA PODER CREAR UN CONTENEDOR POR CADA ALTERNATIVAS QUE
             * SE ENCUENTRE DENTRO DEL JSON. (EL TOTAL DE ALTERNATIVAS SIEMPRE ES 4).
             *
             * ****************************************************************** */
            var html = "";
            var index = 1;
            $.each(response, function (llave, valor) {
                try {
                    ...
                    console.log(e)
                    alert("Lo sentimos. Ha ocurrido un error calculando una ruta");
                }
            });
